...
**当前版本 v2.2.0** ｜ [更新日志](docs/更新日志.md) ｜ [数据管控说明](docs/数据管控与合规.md) ｜ [维护指南](docs/维护指南.md) ｜ [发布与推送](docs/发布与推送.md)
...
| B 站缓存提取 | 播放条上的电视图标：选一个本机 B 站缓存文件夹，**按音频内容识别**里面的 `.m4s`，并补齐标题 / UP 主 / 封面（副本仅存于会话临时目录） |
...
│   ├── 发布与推送.md            # 推标签 → CI 出 Setup.exe → 挂 Release 的完整流程
│   └── 更新日志.md
...
- [发布与推送](docs/发布与推送.md) —— 推标签、CI 出包、发布后核对
- [更新日志](docs/更新日志.md)
